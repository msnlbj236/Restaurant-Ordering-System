...
public class FoodTypeServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(method != null && !method.equals("") && method.equals("list")) {
			...
			System.out.println("  Quantity："+foodTypes.size()+"  foodTypes:"+foodTypes);
			...
			System.out.println("Update foodType："+foodType);
			...
			if(foodType == null) {
				...
				System.out.println("Before changes："+foodType2);
				foodType2.setTypeName(foodTypeName);
				System.out.println("After changes："+foodType2);
