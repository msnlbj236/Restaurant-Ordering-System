	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/sys/dinnerTable.action?method=list">Tables</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/foodType.action?method=list">Food type</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/food.action?method=list">Menu</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/order.action?method=list">Orders</a>
				</li>
				<li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/userList.action?method=list">Users</a>
				</li>
            </ul>
        </li>
    </ul>
