...
<html>
<head>
<title>Add food to your shopping list</title>
												...
												<div class="back">
													...
													<form action="#" method="post">
														...
														<button type="button"  onclick="addShopCar(${food.id})" class="w3ls-cart pw3ls-cart">
															<i class="fa fa-cart-plus" aria-hidden="true"></i>add to shopping list
														</button>
				...
				<div class="rsidebar-top">
					<div class="sidebar-row">
						<ol class="breadcrumb w3l-crumbs">
							<li class="active">${dinnerTable.tableName}'s shopping list</li> 
						</ol>
							...
							<div style="float:right;margin-top: 10px;">                    
								总金额:<fmt:formatNumber value="${total}"  pattern="0.00"></fmt:formatNumber>
									...
									<c:if test="${dinnerTable.tableStatus == 1}">
										<input type="button"  onclick="order(${dinnerTable.id})" value="Place the order"></input>
										<input type="button"  onclick="orderDinner(${dinnerTable.id},0)" value="Cancel the reservation"></input>  
									</c:if>
									<c:if test="${dinnerTable.tableStatus == 0}">
										<input type="button"  onclick="orderDinner(${dinnerTable.id},1)" value="Make a reservation"></input>  
									</c:if>
							</div>    
						</form>
						<div class="clearfix"> </div> 
