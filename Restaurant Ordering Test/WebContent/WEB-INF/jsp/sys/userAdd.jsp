...
<script type="text/javascript">
	...
	function ajaxloginName(){
		...
		if(loginName == null || loginName == ""){
			$("#error").html("User name cannot be blank");
			flag = false;
		}else{
			//查询用户输入的菜品名是否已经存在
			jQuery.ajax({
	...
	function checkPhoneOnblur(obj){
		...
		if(!checkPhone(obj.value)){
			document.getElementById("error").innerHTML="Phone number format is wrong！";
		}
	...
	function checkForm(){
		...
		if(loginName=="" ||password==""||phone=="" ||password==""||Okpassword==""||email==""){
			document.getElementById("error").innerHTML="Information not completed！";
			return false;
		} else if(password !=Okpassword){
			document.getElementById("error").innerHTML="The passwords are not consistent！";
			return false;
...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="../images/sys/title_arrow.gif"/> Add new user
		</div>
    </div>
...
<div id="MainArea">
	...
	<form id="form" action="${ctx}/sys/userList.action" method="post" onsubmit="return checkForm()" >
		...
		<div class="ItemBlock_Title">
        	<img width="4" height="7" border="0" src="../images/sys/item_point.gif">User information&nbsp;<font id="error" color="red"></font>
        </div>
		<!-- 本段表单字段 -->
