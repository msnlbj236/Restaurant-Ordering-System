...
<script type="text/javascript">
	...
	function blurFn(obj,orderDetailId,buyNum,vat){
		...
		if(num <1 || isNaN(num)){
			...
			obj.value = buyNum;
			$("#"+vat).html("Please enter quantity of correct format.");
		}else if(num != buyNum){
			...
			<div class="col-md-12 ">
				...
				<div class="rsidebar-top col-md-12">
					<!-- 遍历所有的订单 -->
							<div class="sidebar-row">
								<h4>
									<span class="col-md-10">
										...
										Order placed time：<fmt:formatDate value="${order.orderDate}"  pattern="yyyy-MM-dd HH:mm:ss"/>&nbsp;
									</span>
								</h4>
							...
							Total：￥<fmt:formatNumber value="${order.totalPrice }" pattern="0.00"></fmt:formatNumber>&nbsp;
							<hr>
							</div>
				</div>	 
				</div>
